...
export default function EmptyState({ title = "Your practice data starts here", description = "Add your first solved problem to unlock personalized analytics.", link = "/app/problems/new" }) {
  return (
    <div className="card grid min-h-72 place-items-center text-center">
      <div>
        ...
        <Link to={link} className="btn-primary mt-5">Add a problem</Link>
      </div>
    </div>
  );
}
