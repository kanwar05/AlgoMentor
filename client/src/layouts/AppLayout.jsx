...
import { BarChart3, BookOpenCheck, BrainCircuit, BriefcaseBusiness, ChevronRight, ClipboardList, CloudDownload, LayoutDashboard, LogOut, Menu, Moon, Route, Sparkles, Sun, UserRound, X } from "lucide-react";
...
const nav = [
  ...
  { to: "/app/mock-interview", label: "Mock interview", icon: BriefcaseBusiness },
